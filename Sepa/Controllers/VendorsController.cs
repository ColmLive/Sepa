...
namespace Sepa.Controllers
{
    public class VendorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Vendor_ID,Vendor_Name,Vendor_Address,Vendor_Address2,Vendor_City,Vendor_Country,Vendor_Currency,Vendor_Email,Vendor_Phone")] Vendor vendor)
        {
